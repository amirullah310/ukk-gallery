...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sqlFoto = "SELECT foto.*, user.userid AS user_userid, user.namalengkap AS user_namalengkap, album.albumid AS album_albumid, album.namaalbum AS album_namaalbum FROM foto JOIN user ON foto.userid = user.userid JOIN album ON foto.albumid = album.albumid WHERE DATE(foto.tanggalunggah) = '$searchDate'";
} else {
        ...
        <div class="row justify-content-start">
            <div class="col-md-4">
                <form method="post" class="form-inline">
                    ...
                    <label for="search_date" class="mr-2 w-100">Cari berdasarkan Tanggal:</label>
